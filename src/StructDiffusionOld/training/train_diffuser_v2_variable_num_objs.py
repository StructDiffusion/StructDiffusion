...
from StructDiffusion.models.models import TransformerDiffuserVariableNumObjs
    ...
    for epoch in range(num_epochs):
        ...
        with tqdm.tqdm(total=len(data_iter["train"])) as pbar:
            for step, batch in enumerate(data_iter["train"]):
                ...
                struct_xyztheta_outputs, obj_xyztheta_outputs = model.forward(t, xyzs, obj_xyztheta_inputs, struct_xyztheta_inputs,
...
def load_model(model_dir):
    ...
    # initialize model
    model_cfg = cfg.model
    model = TransformerDiffuserVariableNumObjs(num_attention_heads=model_cfg.num_attention_heads,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", help='config yaml file',
                        default='../configs/diffuser_v2_shapes.yaml',
                        type=str)
