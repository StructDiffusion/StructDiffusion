...
from StructDiffusion.models.models import TransformerDiffuserLangSentenceEmb
...
def load_model(model_dir):
    ...
    # initialize model
    model_cfg = cfg.model
    model = TransformerDiffuserLangSentenceEmb(sentence_embedding_size=384,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", help='config yaml file',
                        default='../../configs/diffuser_v4_lang_template_language.yaml',
                        type=str)
