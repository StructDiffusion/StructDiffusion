...
# diffusion model
from StructDiffuser.test_diffuser_v5_compositional_two_perturbation import DiffuserInference
...
def evaluate(structure_type, invalid_noise_weight,
    ...
    prior_inference = DiffuserInference(generator_model_dir, data_split, override_data_dirs, override_index_dirs,
                                        invalid_noise_weight=invalid_noise_weight)
...
if __name__ == "__main__":
    ...
    for inw in [0.1, 0.5, 1.0, 2.0]:
        ...
        evaluate(structure_type="dinner",
                 invalid_noise_weight=inw,
                generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220909-213428/model",
                data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_two_perturbation_i{}_dinner_10k_test_objects_100".format(inw),
                test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
        ...
        evaluate(structure_type="line",
                 invalid_noise_weight=inw,
                generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220909-213428/model",
                data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_two_perturbation_i{}_line_10k_test_objects_100".format(inw),
                test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
                object_model_dir="/home/weiyu/Research/intern/brain_gym/data/acronym_handpicked_v4",
                redirect_stdout=True, shuffle=False, summary_writer=None, max_num_eval=100, visualize=False,
        ...
        evaluate(structure_type="circle",
                 invalid_noise_weight=inw,
                generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220909-213428/model",
                data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_two_perturbation_i{}_circle_10k_test_objects_100".format(inw),
                test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
                object_model_dir="/home/weiyu/Research/intern/brain_gym/data/acronym_handpicked_v4",
                redirect_stdout=True, shuffle=False, summary_writer=None, max_num_eval=100, visualize=False,
        ...
        evaluate(structure_type="tower",
                 invalid_noise_weight=inw,
                generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220909-213428/model",
                data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_two_perturbation_i{}_stacking_10k_test_objects_100".format(inw),
                test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
                object_model_dir="/home/weiyu/Research/intern/brain_gym/data/acronym_handpicked_v4",
                redirect_stdout=True, shuffle=False, summary_writer=None, max_num_eval=100, visualize=False,
