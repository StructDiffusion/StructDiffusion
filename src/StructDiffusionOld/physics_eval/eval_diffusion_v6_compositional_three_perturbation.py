...
# diffusion model
from StructDiffuser.test_diffuser_v6_compositional_three_perturbation import DiffuserInference

# physics eval
from src.generative_models.try_langevin_actor_vae_3networks_language_all_shapes_discriminator_7 import switch_stdout, visualize_batch_pcs, convert_bool, save_dict_to_h5
from brain2.semantic_rearrangement.physics_verification_dinner import verify_datum_in_simulation


def evaluate(structure_type, invalid_noise_weight, valid_noise_weight,
    ...
    prior_inference = DiffuserInference(generator_model_dir, data_split, override_data_dirs, override_index_dirs,
                                        invalid_noise_weight=invalid_noise_weight, valid_noise_weight=valid_noise_weight)
    ...
    for inw in [2.0, 0.2]:
        for vnw in [2.0, 0.2]:
            ...
            evaluate(structure_type="dinner",
                     invalid_noise_weight=2.0,
                     valid_noise_weight=2.0,
                    generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220910-195659/model",
                    data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_three_perturbation_i{}v{}_dinner_10k_test_objects_100".format(inw, vnw),
                    test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
            ...
            evaluate(structure_type="line",
                     ...
                     valid_noise_weight=2.0,
                    generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220910-195659/model",
                    data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_three_perturbation_i{}v{}_line_10k_test_objects_100".format(inw, vnw),
                    test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
                    object_model_dir="/home/weiyu/Research/intern/brain_gym/data/acronym_handpicked_v4",
                    redirect_stdout=True, shuffle=False, summary_writer=None, max_num_eval=100, visualize=False,
            ...
            evaluate(structure_type="circle",
                     ...
                     valid_noise_weight=2.0,
                    generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220910-195659/model",
                    data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_three_perturbation_i{}v{}_circle_10k_test_objects_100".format(inw, vnw),
                    test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
                    object_model_dir="/home/weiyu/Research/intern/brain_gym/data/acronym_handpicked_v4",
                    redirect_stdout=True, shuffle=False, summary_writer=None, max_num_eval=100, visualize=False,
            ...
            evaluate(structure_type="tower",
                     ...
                     valid_noise_weight=2.0,
                    generator_model_dir="/home/weiyu/Research/intern/StructDiffuser/experiments/20220910-195659/model",
                    data_split="train", data_root="/home/weiyu/data_drive/physics_eval_diffuser_compositional_three_perturbation_i{}v{}_stacking_10k_test_objects_100".format(inw, vnw),
                    test_specific_shape=None, assets_path="/home/weiyu/Research/intern/brain_gym/assets/urdf",
                    object_model_dir="/home/weiyu/Research/intern/brain_gym/data/acronym_handpicked_v4",
                    redirect_stdout=True, shuffle=False, summary_writer=None, max_num_eval=100, visualize=False,
