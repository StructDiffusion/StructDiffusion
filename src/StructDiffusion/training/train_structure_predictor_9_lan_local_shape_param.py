...
from StructDiffusion.models.semantic_rearrangement_discriminators import DiscriminatorWholeSceneLanguageMLPFusionBN
    ...
    for epoch in range(num_epochs):
        ...
        with tqdm.tqdm(total=len(data_iter["train"])) as pbar:
            ...
            for step, batch in enumerate(data_iter["train"]):
                ...
                preds = model.forward(scene_xyz, sentence, sentence_pad_mask, position_index)
...
def load_model(model_dir):
    ...
    # initialize model
    model_cfg = cfg.model
    model = DiscriminatorWholeSceneLanguageMLPFusionBN(vocab_size,
                                          ...
                                          include_env_pc=cfg.dataset.include_env_pc,
    ...
    return cfg, model, optimizer, scheduler, epoch, tokenizer
...
def run_model(cfg):
    ...
    train_dataset = SemanticArrangementDataset(data_cfg.dirs, data_cfg.index_dirs, "train",
                                               tokenizer=tokenizer,
    ...
    valid_dataset = SemanticArrangementDataset(data_cfg.dirs, data_cfg.index_dirs, "valid",
                                               tokenizer=tokenizer,
                                               num_random_negative_examples=data_cfg.num_random_negative_examples,
                                               min_translation=data_cfg.min_translation,
                                               max_translation=data_cfg.max_translation,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", help='config yaml file',
                        default='configs/new_discriminators/sturcture_predictor_3d_planar_small_shapes_PCT_random_sampling_more_pts_lan_local_shape_param_24k.yaml',
                        type=str)
