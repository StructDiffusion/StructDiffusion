...
class SemanticArrangementDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_roots, index_roots, split, tokenizer,
                 ...
                 normalize_pc=False, return_current_obj_xyzs=False, return_structure_type_index=False):
    ...
    def get_raw_data(self, idx, inference_mode=False):
        ...
        # final_step_t = num_rearrange_objs
...
if __name__ == "__main__":
    ...
    dataset = SemanticArrangementDataset(
        ...
        debug=False, data_augmentation=False, include_env_pc=False, normalize_pc=True, return_current_obj_xyzs=True,
        return_structure_type_index=True)
