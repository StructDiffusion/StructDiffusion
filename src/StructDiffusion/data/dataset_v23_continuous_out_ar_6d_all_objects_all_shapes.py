    ...
    def get_raw_data(self, idx, inference_mode=False, shuffle_object_index=False):
        ...
        if self.debug:
            ...
            for i, obj_xyz in enumerate(obj_xyzs):
                ...
                goal_pc_pose = obj_pc_rotations[i]
                goal_pc_pose[:3, 3] = [goal_obj_pc_centers[i][0], goal_obj_pc_centers[i][1], goal_obj_pc_centers[i][2]]
                ...
                goal_pc_transform = structure_pose @ goal_pc_pose @ np.linalg.inv(current_pc_pose)
            ...
            show_pcs(new_obj_xyzs + other_obj_xyzs, new_obj_rgbs + other_obj_rgbs)
        # -----------------------------------
...
if __name__ == "__main__":
    # tokenizer = Tokenizer(os.path.join("/home/weiyu/data_drive/examples_table_setting_with_gifs/result", "type_vocabs_coarse.json"))
    # dataset = SemanticArrangementDataset(data_root="/home/weiyu/data_drive/examples_table_setting_with_gifs/result",
    #                                      index_root="index_9k",
    ...
    # tokenizer = Tokenizer(
    #     os.path.join("/home/weiyu/data_drive/examples_towers_with_gifs/result", "type_vocabs_coarse.json"))
    # dataset = SemanticArrangementDataset(data_root="/home/weiyu/data_drive/examples_towers_with_gifs/result",
    #                                      index_root="index_25k",
    #                                      split="train", tokenizer=tokenizer,
    #                                      max_num_objects=7,
    #                                      max_num_other_objects=5,
    #                                      max_num_shape_parameters=5,
    ...
    # tokenizer = Tokenizer(
    #     os.path.join("/home/weiyu/data_drive/examples_circles_and_lines/result", "type_vocabs_coarse.json"))
    # dataset = SemanticArrangementDataset(data_root="/home/weiyu/data_drive/examples_circles_and_lines/result",
    #                                      index_root="index_10k",
    #                                      split="train", tokenizer=tokenizer,
    #                                      max_num_objects=7,
    #                                      max_num_other_objects=5,
    #                                      max_num_shape_parameters=5,
    ...
    # print(dataset.get_positive_ratio())
    # dataset.test()
    # dataset.helper_iterate_through_files()
    ...
    data_roots = []
    index_roots = []
    for shape, index in [("stacking", "index_10k")]: # [("circle", "index_34k"), ("line", "index_42k"), ("tower", "index_13k"), ("dinner", "index_24k")]:
    ...
    dataset = SemanticArrangementDataset(data_roots=data_roots,
                                         ...
                                         max_num_anchor_features=0,
                                         num_pts=1024,
                                         debug=True, data_augmentation=False, shuffle_object_index=False)
