...
class SemanticArrangementDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_roots, index_roots, split, tokenizer,
                 ...
                 data_augmentation=True, return_full_sentence=False):
        """
        ...
        self.return_full_sentence = return_full_sentence
        ...
        with open("/home/weiyu/Research/intern/StructDiffuser/src/StructDiffuser/language/template_sentence_data.pkl", "rb") as fh:
    ...
    def get_raw_data(self, idx, inference_mode=False, shuffle_object_index=False):
        ...
        if not self.return_full_sentence:
        ...
        if self.debug:
            ...
            print("type_value_tuple",  type_value_tuple)
            print("template_sentence", template_sentence)
            # plt.figure()
            # plt.imshow(rgb)
            # plt.show()
            #
        ...
        datum = {
            ...
            "type_value_tuple": type_value_tuple,
    ...
    def convert_to_tensors(datum, tokenizer):
        ...
        tensors = {
            ...
            "sentence_embedding": torch.FloatTensor([datum["sentence_embedding"]]),
            "template_sentence": str(datum["template_sentence"]),
            "type_value_tuple": str(datum["type_value_tuple"]),
